...
class LibraryFragment : Fragment() {
    ...
    private fun updateFilter() {
        ...
        val categoryFiltered = when {
            ...
            !isGymMode -> allExercises.filter { it.category == ExerciseCategory.UPPER_CORE }
            else -> allExercises.filter { it.category == ExerciseCategory.LOWER_CARDIO }
        }
        ...
        binding.tvLibraryResultCount.text = getString(R.string.library_exercise_count_format, finalFiltered.size)
        ...
        inner class ViewHolder(
            ...
            fun bind(item: LibraryExercise) {
                ...
                if (item.isCustom) {
                    ...
                    binding.tvLibCategoryBadge.text = item.categoryLabel.uppercase(Locale.getDefault())
                    binding.tvLibCategoryBadge.setTextColor(
